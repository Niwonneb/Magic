package com.magic_app.magic.view.slider.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.magic_app.magic.view.slider.Animations.BaseAnimationInterface}
 * work.
 *

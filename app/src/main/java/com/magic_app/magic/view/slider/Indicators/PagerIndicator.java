package com.magic_app.magic.view.slider.Indicators;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    /**
     * bind this Indicator with {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx}
     */
    ...
    /**
     *This value is from {@link com.magic_app.magic.view.slider.SliderAdapter} getRealCount() represent
     *
    ...
    public void destroySelf(){
        ...
        ReloadingPagerAdapter wrapper = (ReloadingPagerAdapter)mPager.getAdapter();
    ...
    public void setViewPager(ViewPagerEx pager){
        ...
        ((ReloadingPagerAdapter)mPager.getAdapter()).getRealAdapter().registerDataSetObserver(dataChangeObserver);
    }
    ...
    private int getShouldDrawCount(){
        if(mPager.getAdapter() instanceof ReloadingPagerAdapter){
            return ((ReloadingPagerAdapter)mPager.getAdapter()).getRealCount();
        }else{
    ...
    private DataSetObserver dataChangeObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            int count = 0;
            if(adapter instanceof ReloadingPagerAdapter){
                count = ((ReloadingPagerAdapter)adapter).getRealCount();
            }else{

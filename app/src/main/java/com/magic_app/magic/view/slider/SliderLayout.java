package com.magic_app.magic.view.slider;
...
import com.magic_app.magic.view.slider.Animations.BaseAnimationInterface;
import com.magic_app.magic.view.slider.Indicators.PagerIndicator;
import com.magic_app.magic.view.slider.SliderTypes.BaseSliderView;
import com.magic_app.magic.view.slider.Transformers.AccordionTransformer;
import com.magic_app.magic.view.slider.Transformers.BackgroundToForegroundTransformer;
import com.magic_app.magic.view.slider.Transformers.BaseTransformer;
import com.magic_app.magic.view.slider.Transformers.CubeInTransformer;
import com.magic_app.magic.view.slider.Transformers.DefaultTransformer;
import com.magic_app.magic.view.slider.Transformers.DepthPageTransformer;
import com.magic_app.magic.view.slider.Transformers.FadeTransformer;
import com.magic_app.magic.view.slider.Transformers.FlipHorizontalTransformer;
import com.magic_app.magic.view.slider.Transformers.FlipPageViewTransformer;
import com.magic_app.magic.view.slider.Transformers.ForegroundToBackgroundTransformer;
import com.magic_app.magic.view.slider.Transformers.RotateDownTransformer;
import com.magic_app.magic.view.slider.Transformers.RotateUpTransformer;
import com.magic_app.magic.view.slider.Transformers.StackTransformer;
import com.magic_app.magic.view.slider.Transformers.TabletTransformer;
import com.magic_app.magic.view.slider.Transformers.ZoomInTransformer;
import com.magic_app.magic.view.slider.Transformers.ZoomOutSlideTransformer;
import com.magic_app.magic.view.slider.Transformers.ZoomOutTransformer;
import com.magic_app.magic.view.slider.Tricks.FixedSpeedScroller;
import com.magic_app.magic.view.slider.Tricks.ReloadingPagerAdapter;
import com.magic_app.magic.view.slider.Tricks.InfiniteViewPager;
...
/**
 * SliderLayout is compound layout. This is combined with {@link com.magic_app.magic.view.slider.Indicators.PagerIndicator}
 * and {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout{
    ...
    /**
     * {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.magic_app.magic.view.slider.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.magic_app.magic.view.slider.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.magic_app.magic.view.slider.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.magic_app.magic.view.slider.Indicators.PagerIndicator} shape, rect or oval.
     */
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        PagerAdapter wrappedAdapter = new ReloadingPagerAdapter(mSliderAdapter);
     ...
     * {@link com.magic_app.magic.view.slider.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.magic_app.magic.view.slider.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link com.magic_app.magic.view.slider.Indicators.PagerIndicator} instance.
    ...
    private ReloadingPagerAdapter getWrapperAdapter(){
        PagerAdapter adapter = mViewPager.getAdapter();
        if(adapter!=null){
            return (ReloadingPagerAdapter)adapter;
        }else{
            return null;
        }
    }
    ...
    private SliderAdapter getRealAdapter(){
        PagerAdapter adapter = mViewPager.getAdapter();
        if(adapter!=null){
            return ((ReloadingPagerAdapter)adapter).getRealAdapter();
        }
        return null;
    }

package com.magic_app.magic.view.scrolling2;
...
public class TwoDScrollView extends FrameLayout {
    ...
    private void initTwoDScrollView() {
        ...
        // mMaximumVelocity = mMinimumVelocity *// 5;
    ...
    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) { /* * This method JUST determines whether we want to intercept the motion. * If we return true, onMotionEvent will be called and we do the actual * scrolling there. */ /* * Shortcut the most recurring case: the user is in the dragging state * and he is moving his finger. We want to intercept this motion. */
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: /* * mIsBeingDragged == false, otherwise the shortcut would have * caught it. Check whether the user has moved far enough from his * original down touch. */ /* * Locally do absolute value. mLastMotionY is set to the y value of * the down event. */
...
*/
     ...
     *
     * @param direction_vert the scroll direction: {@link android.view.View#FOCUS_UP} to go
